			...
			"i3-1": {
				"中心转发": {
					...
					"i3-1-2": {
						"CLI配置详解": {
							"i3-1-2-1": "配置客户端vlan",
							"i3-1-2-2": "配置policy profile，关联vlan",
							"i3-1-2-3": "配置wlan",
							"i3-1-2-4": "配置tag policy，<br />　　　关联wlan和vlan",
							"i3-1-2-5": "配置ap profile",
							"i3-1-2-6": "配置site tag，关联ap profile",
							"i3-1-2-7": "配置rf tag",
							"i3-1-2-8": "配置ap location tag，<br />　　　关联上述tag",
						}
					},
					"i3-1-3": {
						"GUI配置": {
							...
							"i3-1-3-2": "调用向导配置无线",
							"i3-1-3-3": "配置wlan",
							"i3-1-3-4": "配置policy profile",
							"i3-1-3-5": "配置tag policy，<br />　　　关联wlan和vlan",
							"i3-1-3-6": "配置ap profile",
							"i3-1-3-7": "配置site tag",
							"i3-1-3-8": "配置rf tag",
							"i3-1-3-9": "AP关联上述tag",
						}
			...
			"i3-2": {
				"FlexConnect": {
					...
					"i3-2-2": {
						"CLI配置详解": {
							"i3-2-2-1": "配置客户端vlan",
							"i3-2-2-2": "配置flex profile，<br />　　　配置客户端vlan相关信息",
							"i3-2-2-3": "配置policy profile，关联vlan<br />　　　及flexconnect相关调整",
							"i3-2-2-4": "配置wlan",
							"i3-2-2-5": "配置tag policy，<br />　　　关联wlan和vlan",
							"i3-2-2-6": "配置ap profile",
							"i3-2-2-7": "配置site tag，<br />　　　关联ap profile和flex profile",
							"i3-2-2-8": "配置rf tag",
							"i3-2-2-9": "配置ap location tag，<br />　　　关联上述tag",
						}
					},
					"i3-2-3": {
						"GUI配置": {
							...
							"i3-2-3-2": "调用向导配置无线",
							"i3-2-3-3": "配置wlan",
							"i3-2-3-4": "配置policy profile",
							"i3-2-3-5": "配置tag policy，<br />　　　关联wlan和vlan",
							"i3-2-3-6": "配置ap profile",
							"i3-2-3-7": "配置flex profile，<br />　　　配置客户端vlan相关信息",
							"i3-2-3-8": "配置site tag，<br />　　　关联ap profile和flex profile",
							"i3-2-3-9": "配置rf tag",
							"i3-2-3-10": "AP关联上述tag"
						}
					},
			...
			"i8": {
				"中心802.1x": {
					...
					"i8-3": {
						"GUI配置": {
							"i8-3-1": "配置wlan",
							"i8-3-2": "配置policy profile",
							"i8-3-3": "配置flex profile<br />　　（flexconnect）",
						}
					},
				}
			},
		...
		"网页认证": {
			"i10": {
				"本地网页认证": {
					...
					"i10-2": {
						"CLI配置详解": {
							"i10-2-1": "删除所有客户端mac地址",
							"i10-2-2": "配置网页认证策略",
							"i10-2-3": "配置网页认证用户",
							"i10-2-4": "修改认证页面",
							"i10-2-5": "配置wlan采用网页认证",
						}
					},
			...
			"i11": {
				"中心网页认证": {
					...
					"i11-2": {
						"CLI配置详解": {
							"i11-2-1": "删除所有客户端mac地址",
							"i11-2-2": "配置授权策略",
							"i11-2-3": "配置ACL",
							"i11-2-4": "配置wlan",
							"i11-2-5": "配置policy profile",
						}
					},
...
const vpn_firepower = {
	...
	"i2": {
		"SSL VPN": {
			...
			"i2-2": "配置地址池",
			"i2-3": "按向导配置SSL VPN",
			"i2-4": "修改connect profile",
			"i2-5": "配置group policy",
			"i2-6": "动态授权时，<br />　　　关联group policy到SSL VPN profile",
		}
	},
};
