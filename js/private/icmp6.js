$(document).ready(function () {
    // ------------------------- Type 1 选择器 开始  -----------------------------------
    var _c21 = createSelection("#tICMPv6Type", "_c21");
    var _r2 = createSelection("#tICMPv6Type", "_r2");

    var _c91 = createSelection("#tICMPv6Type", "_c91");

    var Type1_Col1 = createCellSelection("#tICMPv6Type", 1, 1, 2, 9);
    var Type1_Col12 = createCellSelection("#tICMPv6Type", 1, 2, 2, 9);
    var Type1_RowAll = createRowSelection("#tICMPv6Type", 2, 9);
    var Type1_RowType = createRowSelection("#tICMPv6Type", 3, 9);
    // ------------------------- Type 1 选择器 结束 -----------------------------------
    // ------------------------- Type 3 选择器 开始 -----------------------------------
    var _c111 = createSelection("#tICMPv6Type", "_c111");
    var _r11 = createSelection("#tICMPv6Type", "_r11");

    var _c131 = createSelection("#tICMPv6Type", "_c131");

    var Type3_Col1 = createCellSelection("#tICMPv6Type", 1, 1, 11, 13);
    var Type3_Col12 = createCellSelection("#tICMPv6Type", 1, 2, 11, 13);
    var Type3_RowAll = createRowSelection("#tICMPv6Type", 11, 13);
    var Type3_RowType = createRowSelection("#tICMPv6Type", 12, 13);

    // ------------------------- Type 3 选择器 结束 -----------------------------------
    // ------------------------- Type 4 选择器 开始 -----------------------------------
    var _c141 = createSelection("#tICMPv6Type", "_c141");
    var _r14 = createSelection("#tICMPv6Type", "_r14");

    var _c171 = createSelection("#tICMPv6Type", "_c171");

    var Type4_Col1 = createCellSelection("#tICMPv6Type", 1, 1, 14, 17);
    var Type4_Col12 = createCellSelection("#tICMPv6Type", 1, 2, 14, 17);
    var Type4_RowAll = createRowSelection("#tICMPv6Type", 14, 17);
    var Type4_RowType = createRowSelection("#tICMPv6Type", 15, 17);
