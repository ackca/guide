$(document).ready(function () {
    // ------------------------- Type 3 选择器 开始  -----------------------------------
    var _c31 = createSelection("#tICMPv4Type", "_c31");
    var _r3 = createSelection("#tICMPv4Type", "_r3");

    var _c191 = createSelection("#tICMPv4Type", "_c191");

    var Type3_Col1 = createCellSelection("#tICMPv4Type", 1, 1, 3, 19);
    var Type3_Col12 = createCellSelection("#tICMPv4Type", 1, 2, 3, 19);
    var Type3_RowAll = createRowSelection("#tICMPv4Type", 3, 19);
    var Type3_RowType = createRowSelection("#tICMPv4Type", 4, 19);
    // ------------------------- Type 3 选择器 结束 -----------------------------------
    // ------------------------- Type 5 选择器 开始 -----------------------------------
    var _c211 = createSelection("#tICMPv4Type", "_c211");
    var _r21 = createSelection("#tICMPv4Type", "_r21");

    var _c251 = createSelection("#tICMPv4Type", "_c251");

    var Type5_Col1 = createCellSelection("#tICMPv4Type", 1, 1, 21, 25);
    var Type5_Col12 = createCellSelection("#tICMPv4Type", 1, 2, 21, 25);
    var Type5_RowAll = createRowSelection("#tICMPv4Type", 21, 25);
    var Type5_RowType = createRowSelection("#tICMPv4Type", 22, 25);
    // ------------------------- Type 5 选择器 结束 -----------------------------------
    // ------------------------- Type 11 选择器 开始 -----------------------------------
    var _c291 = createSelection("#tICMPv4Type", "_c291");
    var _r29 = createSelection("#tICMPv4Type", "_r29");

    var _c311 = createSelection("#tICMPv4Type", "_c311");

    var Type11_Col1 = createCellSelection("#tICMPv4Type", 1, 1, 29, 31);
    var Type11_Col12 = createCellSelection("#tICMPv4Type", 1, 2, 29, 31);
    var Type11_RowAll = createRowSelection("#tICMPv4Type", 29, 31);
    var Type11_RowType = createRowSelection("#tICMPv4Type", 30, 31);
    // ------------------------- Type 11 选择器 结束 -----------------------------------
    // ------------------------- Type 12 选择器 开始 -----------------------------------
    var _c321 = createSelection("#tICMPv4Type", "_c321");
    var _r32 = createSelection("#tICMPv4Type", "_r32");

    var _c341 = createSelection("#tICMPv4Type", "_c341");

    var Type12_Col1 = createCellSelection("#tICMPv4Type", 1, 1, 32, 34);
    var Type12_Col12 = createCellSelection("#tICMPv4Type", 1, 2, 32, 34);
    var Type12_RowAll = createRowSelection("#tICMPv4Type", 32, 34);
    var Type12_RowType = createRowSelection("#tICMPv4Type", 33, 34);
    // ------------------------- Type 12 选择器 结束 -----------------------------------
    // ------------------------- Type 3 高亮 开始  -----------------------------------
    // ------------------------- Type 3 第一行 -----------------------------------
