...
(function e(t, n, r) {
    ...
    3: [function(require, module, exports) {
        ...
        // 弹下载菜单的js，注意ID，每增加菜单
        $("#nav-header-protocol,#nav-header-cisco,#nav-header-china,#nav-header-others,#nav-header-vmware,#nav-header-netdevops,#nav-header-container,#nav-header-linux").hover(function(e) {
